...
function emailClicked(event) {
  ...
  if (emailBody.classList.contains('email-body-visible')) {
    emailBody.classList.remove('email-body-visible');
  } else {
    emailBody.classList.add('email-body-visible');
  }
}
...
function showEmail(email) {
  ...
  emailBody.className = "email-body-visible";
